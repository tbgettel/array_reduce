...
array of objects passed to it with each object now including the key and value passed to 
the function.
...
is true, the value should be placed in the first subarray. If the result of the callback
